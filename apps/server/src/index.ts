import { createContext } from "@cipher-atlas/api/context";
import { appRouter, type AppRouter } from "@cipher-atlas/api/routers/index";
import { auth } from "@cipher-atlas/auth";
...
const nativeAppUrl = "cipher-atlas://";
