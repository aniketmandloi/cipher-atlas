...
ALTER TABLE "coverage_slice" ADD CONSTRAINT "coverage_slice_scan_attempt_id_scan_attempt_id_fk" FOREIGN KEY ("scan_attempt_id") REFERENCES "public"."scan_attempt"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "coverage_slice_scan_attempt_id_idx" ON "coverage_slice" USING btree ("scan_attempt_id");--> statement-breakpoint
